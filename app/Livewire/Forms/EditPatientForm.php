...
class EditPatientForm extends Form
{
    ...
    protected function rules(): array
    {
        return [
            ...
            'is_4ps' => 'boolean',
            'is_NHTS' => 'boolean',
            'mother_first_name' => 'regex:/^[a-zA-Z\s.-]*$/',
            'mother_middle_name' => 'regex:/^[a-zA-Z\s.-]*$/',
            'mother_last_name' => 'regex:/^[a-zA-Z\s.-]*$/',
            'mother_philhealth' => [
                'regex:/^[0-9]{2}-[0-9]{9}-[0-9]$/',
                Rule::unique('parent_infos', 'philhealth_no')->ignore($this->mother_id),
            ],
            'father_first_name' => 'regex:/^[a-zA-Z\s.-]*$/',
            'father_middle_name' => 'regex:/^[a-zA-Z\s.-]*$/',
            'father_last_name' => 'regex:/^[a-zA-Z\s.-]*$/',
            'father_philhealth' => [
                'regex:/^[0-9]{2}-[0-9]{9}-[0-9]$/',
                Rule::unique('parent_infos', 'philhealth_no')->ignore($this->father_id),
            ],
