...
class Edit extends Component
{
    ...
    public function mount($user_id): void
    {
        ...
        $this->form->edit_birth_date = $this->form->edit_user->birth_date;
        $this->form->edit_sex = $this->form->edit_user->sex;
        ...
        $this->form->edit_password = $this->form->edit_user->password;
        ...
        $this->form->edit_specialization = $this->form->edit_user->doctor->specializations()->first()->name ?? '';
