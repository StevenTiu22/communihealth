<aside id="sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-screen flex flex-col px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800 shadow-lg shadow-gray-200 dark:shadow-gray-700">
      <div class="mt-5">
         <a href="#" class="flex items-center ps-2.5 mb-5">
            <img src="{{ asset('storage/logo/sjc.png') }}" class="h-8 mr-3" alt="San Juan Logo">
      ...
      <ul class="space-y-2 font-medium mt-11">
         <li>
            <a href="{{ route('dashboard.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="ms-3">Disease Monitoring</span>
            </a>
         </li>
         <li>
            <a href="{{ route('patient-records.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <a href="{{ route('scheduling.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Scheduling</span>
            </a>
         </li>
         <li>
      ...
      <ul class="space-y-2 font-medium mt-auto">
         <li>
            <a href="{{ route('logout') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap hover:text-red-600">Log out</span>
            </a>
         </li>
      </ul>
   </div>
