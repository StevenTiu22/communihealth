<aside id="sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-screen flex flex-col px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800 shadow-lg shadow-gray-200 dark:shadow-gray-700">
      ...
      <ul class="space-y-2 font-medium mt-11">
         <li>
            <a href="{{ route('patients') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <a href="{{ route('medicines') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
             ...
             <form method="POST" action="{{ route('logout') }}">
                 ...
                 <button type="submit" class="w-full flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <span class="flex items-center">
                        ...
                        <span class="ms-3 whitespace-nowrap hover:text-red-600">Log out</span>
                    </span>
                 </button>
             </form>
         </li>
