<div class="bg-gray-900 p-4 rounded-lg shadow-md mb-4 space-y-4" x-data="{ isOpen: true }">
    <div class="flex items-center justify-between">
        <button
            @click="isOpen = !isOpen"
            class="flex items-center gap-2 text-lg font-semibold text-gray-100 focus:outline-none"
    ...
    >
        ...
        <div>
            ...
            >
                ...
                @empty
                    <option value="no-category" disabled>No categories found</option>
                @endforelse
            </select>
        </div>
        ...
        <!-- Stock Filter -->
        <div>
            <label class="block text-sm font-medium text-gray-300">Stock Status</label>
            <select
        ...
        <!-- Expiry Filter -->
        <div>
            <label class="block text-sm font-medium text-gray-300">Expiry Status</label>
            <select
