    ...
    <div x-show="open" 
        ...
        <div class="space-y-4">
            <div>
                ...
                <select wire:model="filters.gender" class="w-full rounded-md">
            ...
            <div>
                ...
                <div class="flex space-x-2">
                    <input type="number" wire:model="filters.age_from" placeholder="From" class="w-1/2 rounded-md">
                    <input type="number" wire:model="filters.age_to" placeholder="To" class="w-1/2 rounded-md">
                </div>
            </div>
